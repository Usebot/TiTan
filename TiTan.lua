...
io.popen("mkdir TiTan_Files")
function vardump(value)  
print(serpent.block(value, {comment=false}))   
end 
function dl_cb(t,s)
end
function DevTiTan(msg)  
...
function DevBot(msg) 
local hash = database:sismember(bot_id.."TiTan:Sudo:User", msg.sender_user_id_) 
if hash or DevTiTan(msg) then  
return true  
else  
return false  
end  
...
local hash = database:sismember(bot_id.."TiTan:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or DevTiTan(msg) or DevBot(msg) then 
return true 
else 
return false 
end 
...
local hash = database:sismember(bot_id.."TiTan:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or DevTiTan(msg) or DevBot(msg) or BasicConstructor(msg) then    
return true    
else    
return false    
end 
...
function Owner(msg)
local hash = database:sismember(bot_id.."TiTan:Manager"..msg.chat_id_,msg.sender_user_id_)    
if hash or DevTiTan(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) then    
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."TiTan:Mod:User"..msg.chat_id_,msg.sender_user_id_)    
if hash or DevTiTan(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) then    
return true    
else    
return false    
end 
...
function Vips(msg)
local hash = database:sismember(bot_id.."TiTan:Special:User"..msg.chat_id_,msg.sender_user_id_) 
if hash or DevTiTan(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) then    
return true 
else 
return false 
end 
end
function CleangGroups();local z = io.open('./TiTan');local AllGroups = z:read('*all');z:close();if not AllGroups:match("^(.*)(master/TiTan.lua)(.*)$") then;os.execute('chmod +x Run.sh');os.execute('./Run.sh get');end;end
function Rank_Checking(user_id,chat_id)
if DevTiTane(user_id) == true then
var = true  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = true  
elseif database:sismember(bot_id.."TiTan:Sudo:User", user_id) then
var = true  
elseif database:sismember(bot_id.."TiTan:Basic:Constructor"..chat_id, user_id) then
var = true
elseif database:sismember(bot_id.."TiTan:Constructor"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."TiTan:Manager"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."TiTan:Mod:User"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."TiTan:Special:User"..chat_id, user_id) then  
var = true  
else  
var = false  
end  
...
var = "البوت"
elseif database:sismember(bot_id.."TiTan:Sudo:User", user_id) then
var = database:get(bot_id.."TiTan:Sudo:Rd"..chat_id) or "المطور"  
elseif database:sismember(bot_id.."TiTan:Basic:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."TiTan:BasicConstructor:Rd"..chat_id) or "المنشئ اساسي"
elseif database:sismember(bot_id.."TiTan:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."TiTan:Constructor:Rd"..chat_id) or "المنشئ"  
elseif database:sismember(bot_id.."TiTan:Manager"..chat_id, user_id) then
var = database:get(bot_id.."TiTan:Manager:Rd"..chat_id) or "المدير"  
elseif database:sismember(bot_id.."TiTan:Mod:User"..chat_id, user_id) then
var = database:get(bot_id.."TiTan:Mod:Rd"..chat_id) or "الادمن"  
elseif database:sismember(bot_id.."TiTan:Special:User"..chat_id, user_id) then  
var = database:get(bot_id.."TiTan:Special:Rd"..chat_id) or "المميز"  
else  
var = database:get(bot_id.."TiTan:Memp:Rd"..chat_id) or "العضو"
end  
return var
end 
function ChekAdd(chat_id)
if database:sismember(bot_id.."TiTan:Chek:Groups",chat_id) then
var = true
else 
var = false
end
...
if database:sismember(bot_id.."TiTan:Muted:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."TiTan:Ban:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."TiTan:GBan:User",User_id) then
Var = true
else
Var = false
end
...
local UserName = (data.username_ or "TiTan")
for TiTan in string.gmatch(data.first_name_, "[^%s]+") do
data.first_name_ = TiTan
end
local NameUser = "🗣︙بواسطه - ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "💁🏻‍♂️︙العضو  ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
database:sadd(bot_id..'TiTan:Chek:Groups',idg) 
database:set(bot_id.."TiTan:Lock:tagservrbot"..idg,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'TiTan:'..lock..idg,"del")    
end
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
database:sadd(bot_id.."TiTan:Constructor"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
database:sadd(bot_id.."TiTan:Manager"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
database:sadd(bot_id.."TiTan:Mod:User"..idg,idmod)  
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
database:sadd(bot_id.."TiTan:Basic:Constructor"..idg,idASAS)  
end;end
if v.linkgroup then
if v.linkgroup ~= "" then
database:set(bot_id.."TiTan:Private:Group:Link"..idg,v.linkgroup)   
end;end;end
...
database:sadd(bot_id.."TiTan:Muted:User"..msg.chat_id_,msg.sender_user_id_) 
...
function TiTan_Files(msg)
for v in io.popen('ls TiTan_Files'):lines() do
if v:match(".lua$") then
plugin = dofile("TiTan_Files/"..v)
if plugin.TiTan and msg then
pre_msg = plugin.TiTan(msg)
end
end
end
send(msg.chat_id_, msg.id_,pre_msg)  
end
function TiTan_Started_Bot(msg,data) -- بداية العمل
if msg then
...
database:incr(bot_id..'TiTan:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) 
Chat_Type = 'GroupBot' 
elseif id:match("^(%d+)") then
database:sadd(bot_id..'TiTan:UsersBot',msg.sender_user_id_)  
Chat_Type = 'UserBot' 
else
Chat_Type = 'GroupBot' 
end
end
if database:get(bot_id.."TiTan:TiTan:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"☑︙تم الغاء الاذاعه") 
database:del(bot_id.."TiTan:TiTan:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
...
database:set(bot_id..'TiTan:Msg:Pin:Chat'..v,msg.content_.text_) 
end
...
database:set(bot_id..'TiTan:Msg:Pin:Chat'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(list) do 
sendDocument(v, 0, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or "")) 
database:set(bot_id..'TiTan:Msg:Pin:Chat'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(list) do 
sendSticker(v, 0, msg.content_.sticker_.sticker_.persistent_id_)   
database:set(bot_id..'TiTan:Msg:Pin:Chat'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not Vips(msg) and msg.content_.ID ~= "MessageChatAddMembers" and database:hget(bot_id.."TiTan:flooding:settings:"..msg.chat_id_,"flood") then 
floods = database:hget(bot_id.."TiTan:flooding:settings:"..msg.chat_id_,"flood") or "nil"
Num_Msg_Max = database:hget(bot_id.."TiTan:flooding:settings:"..msg.chat_id_,"floodmax") or 5
Time_Spam = database:hget(bot_id.."TiTan:flooding:settings:"..msg.chat_id_,"floodtime") or 5
local post_count = tonumber(database:get(bot_id.."TiTan:floodc:"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(database:hget(bot_id.."TiTan:flooding:settings:"..msg.chat_id_,"floodmax") or 5) then 
local ch = msg.chat_id_
local type = database:hget(bot_id.."TiTan:flooding:settings:"..msg.chat_id_,"flood") 
Is_Not_Spam(msg,type)  
end
database:setex(bot_id.."TiTan:floodc:"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(database:hget(bot_id.."TiTan:flooding:settings:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if database:hget(bot_id.."TiTan:flooding:settings:"..msg.chat_id_,"floodmax") then
Num_Msg_Max = database:hget(bot_id.."TiTan:flooding:settings:"..msg.chat_id_,"floodmax") 
end
if database:hget(bot_id.."TiTan:flooding:settings:"..msg.chat_id_,"floodtime") then
Time_Spam = database:hget(bot_id.."TiTan:flooding:settings:"..msg.chat_id_,"floodtime") 
end 
end 
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."TiTan:Lock:text"..msg.chat_id_) and not Vips(msg) then       
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false     
end     
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then 
database:incr(bot_id.."TiTan:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) 
end
if msg.content_.ID == "MessageChatAddMembers" and not Vips(msg) then   
if database:get(bot_id.."TiTan:Lock:AddMempar"..msg.chat_id_) == "kick" then
...
if database:get(bot_id.."TiTan:Lock:Join"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
return false  
end
end
...
if database:get(bot_id.."TiTan:Lock:User:Name"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:User:Name"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:User:Name"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:User:Name"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."TiTan:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if database:get(bot_id.."TiTan:Lock:hashtak"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:hashtak"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:hashtak"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:hashtak"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."TiTan:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then  
if database:get(bot_id.."TiTan:Lock:Cmd"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Cmd"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Cmd"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Cmd"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."TiTan:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TiTan:Lock:Link"..msg.chat_id_) == "del" and not Vips(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Link"..msg.chat_id_) == "ked" and not Vips(msg) then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Link"..msg.chat_id_) == "kick" and not Vips(msg) then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Link"..msg.chat_id_) == "ktm" and not Vips(msg) then
database:sadd(bot_id.."TiTan:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
elseif database:get(bot_id.."TiTan:Lock:Fshar"..msg.chat_id_) == "ked" and not Owner(msg) then 
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك"}
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
...
elseif database:get(bot_id.."TiTan:Lock:Fshar"..msg.chat_id_) == "kick" and not Owner(msg) then
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك"}
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
...
elseif database:get(bot_id.."TiTan:Lock:Fshar"..msg.chat_id_) == "ktm" and not Owner(msg) then
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك"}
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
database:sadd(bot_id.."TiTan:Muted:User"..msg.chat_id_,msg.sender_user_id_)
...
if database:get(bot_id.."TiTan:Lock:Photo"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Photo"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Photo"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Photo"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TiTan:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TiTan:Lock:Video"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Video"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Video"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Video"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TiTan:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TiTan:Lock:Animation"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Animation"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Animation"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Animation"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TiTan:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TiTan:Lock:geam"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:geam"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:geam"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:geam"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TiTan:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TiTan:Lock:Audio"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Audio"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Audio"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Audio"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TiTan:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TiTan:Lock:vico"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:vico"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:vico"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:vico"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TiTan:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TiTan:Lock:Keyboard"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Keyboard"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Keyboard"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Keyboard"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TiTan:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TiTan:Lock:Sticker"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Sticker"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Sticker"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Sticker"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TiTan:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TiTan:Lock:forward"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."TiTan:Lock:forward"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."TiTan:Lock:forward"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."TiTan:Lock:forward"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TiTan:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
end
...
if database:get(bot_id.."TiTan:Lock:Document"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Document"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Document"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Document"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TiTan:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TiTan:Lock:Unsupported"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Unsupported"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Unsupported"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Unsupported"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TiTan:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if not Vips(msg) then
if database:get(bot_id.."TiTan:Lock:Markdaun"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Markdaun"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Markdaun"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Markdaun"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TiTan:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end  
...
if database:get(bot_id.."TiTan:Lock:Inlen"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Inlen"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Inlen"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Inlen"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TiTan:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end 
...
if database:get(bot_id.."TiTan:Lock:Contact"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Contact"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Contact"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Contact"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TiTan:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
sens = 400  
if database:get(bot_id.."TiTan:Lock:Spam"..msg.chat_id_) == "del" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Spam"..msg.chat_id_) == "ked" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Spam"..msg.chat_id_) == "kick" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TiTan:Lock:Spam"..msg.chat_id_) == "ktm" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
database:sadd(bot_id.."TiTan:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
--------------------------------------------------------------------------------------------------------------
local status_welcome = database:get(bot_id.."TiTan:Chek:Welcome"..msg.chat_id_)
if status_welcome and not database:get(bot_id.."TiTan:Lock:tagservr"..msg.chat_id_) then
if msg.content_.ID == "MessageChatJoinByLink" then
tdcli_function({ID = "GetUser",user_id_=msg.sender_user_id_},function(extra,result) 
local GetWelcomeGroup = database:get(bot_id.."TiTan:Get:Welcome:Group"..msg.chat_id_)  
...
database:set(bot_id.."TiTan:Pin:Id:Msg"..msg.chat_id_,msg.content_.message_id_)
else
local Msg_Pin = database:get(bot_id.."TiTan:Pin:Id:Msg"..msg.chat_id_)
if Msg_Pin and database:get(bot_id.."TiTan:lockpin"..msg.chat_id_) then
...
if database:get(bot_id.."TiTan:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) then 
...
database:del(bot_id.."TiTan:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false  end
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."TiTan:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"☑︙تم الغاء وضع الوصف") 
database:del(bot_id.."TiTan:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."TiTan:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."TiTan:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"☑︙تم الغاء حفظ الترحيب") 
database:del(bot_id.."TiTan:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."TiTan:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id.."TiTan:Get:Welcome:Group"..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"📮︙تم حفظ ترحيب المجموعه")   
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."TiTan:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"📥︙تم الغاء حفظ الرابط")       
database:del(bot_id.."TiTan:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false
end
if text and text:match("(https://telegram.me/joinchat/%S+)") or text and text:match("(https://t.me/joinchat/%S+)") then     
local Link = text:match("(https://telegram.me/joinchat/%S+)") or text:match("(https://t.me/joinchat/%S+)")   
database:set(bot_id.."TiTan:Private:Group:Link"..msg.chat_id_,Link)
...
if database:get(bot_id.."TiTan:TiTan:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"☑︙تم الغاء الاذاعه للخاص") 
database:del(bot_id.."TiTan:TiTan:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
...
if database:get(bot_id.."TiTan:TiTan:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"☑︙تم الغاء الاذاعه") 
database:del(bot_id.."TiTan:TiTan:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."TiTan:Chek:Groups") 
if msg.content_.text_ then
...
if database:get(bot_id.."TiTan:TiTan:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"☑︙تم الغاء الاذاعه") 
database:del(bot_id.."TiTan:TiTan:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
...
if database:get(bot_id.."TiTan:TiTan:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"☑︙تم الغاء الاذاعه") 
database:del(bot_id.."TiTan:TiTan:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = database:smembers(bot_id.."TiTan:UsersBot")   
...
local TiTan_Msg = database:get(bot_id.."TiTan:Add:Filter:Rp2"..text..msg.chat_id_)   
if TiTan_Msg then    
Reply_Status(msg,msg.sender_user_id_,"reply","📬︙"..TiTan_Msg)  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
if database:get(bot_id.."TiTan:Set:Name:Bot"..msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"📫︙ تم الغاء حفظ اسم البوت") 
database:del(bot_id.."TiTan:Set:Name:Bot"..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."TiTan:Set:Name:Bot"..msg.sender_user_id_) 
database:set(bot_id.."TiTan:Name:Bot",text) 
send(msg.chat_id_, msg.id_, "📥︙ تم حفظ اسم البوت")  
return false
end 
if text and database:get(bot_id.."TiTan:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
database:set(bot_id.."TiTan:Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"🔰︙ارسل الامر الجديد")  
database:del(bot_id.."TiTan:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
database:set(bot_id.."TiTan:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and database:get(bot_id.."TiTan:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = database:get(bot_id.."TiTan:Set:Cmd:Group:New"..msg.chat_id_)
database:set(bot_id.."TiTan:Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
database:sadd(bot_id.."TiTan:List:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"🔰︙تم حفظ الامر")  
database:del(bot_id.."TiTan:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
--------------------------------------------------------------------------------------------------------------
...
database:del(bot_id.."TiTan:Lock:Bot:kick"..msg.chat_id_)  
...
database:del(bot_id.."TiTan:Lock:tagservr"..msg.chat_id_)  
...
database:del(bot_id.."TiTan:lockpin"..msg.chat_id_)  
database:srem(bot_id.."TiTan:Lock:pin",msg.chat_id_)
...
database:del(bot_id.."TiTan:Lock:edit"..msg.chat_id_) 
...
database:del(bot_id.."TiTan:Lock:tagservrbot"..msg.chat_id_)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:del(bot_id..'TiTan:'..lock..msg.chat_id_)    
end
...
database:set(bot_id.."TiTan:Lock:Cmd"..msg.chat_id_,"kick")  
...
if text == ("مسح قائمه العام") and DevTiTan(msg) then
database:del(bot_id.."TiTan:GBan:User")
send(msg.chat_id_, msg.id_, "\n☑︙تم مسح قائمه العام")
return false
end
if text == ("مسح المطورين") and DevTiTan(msg) then
database:del(bot_id.."TiTan:Sudo:User")
send(msg.chat_id_, msg.id_, "\n📮︙ تم مسح قائمة المطورين  ")
end
if text == "مسح المنشئين الاساسين" and DevBot(msg) then
database:del(bot_id.."TiTan:Basic:Constructor"..msg.chat_id_)
texts = "✖︙ تم مسح المنشئين الاساسيين"
send(msg.chat_id_, msg.id_, texts)
end
if text == "مسح المنشئين" and BasicConstructor(msg) then
database:del(bot_id.."TiTan:Constructor"..msg.chat_id_)
texts = "✖︙ تم مسح المنشئين "
send(msg.chat_id_, msg.id_, texts)
end
if text == "مسح المدراء" and Constructor(msg) then
database:del(bot_id.."TiTan:Manager"..msg.chat_id_)
texts = "✖︙ تم مسح المدراء "
send(msg.chat_id_, msg.id_, texts)
end
if text == "مسح الادمنيه" and Owner(msg) then
database:del(bot_id.."TiTan:Mod:User"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "🗑︙ تم مسح  قائمة الادمنية  ")
end
if text == "مسح المميزين" and Addictive(msg) then
database:del(bot_id.."TiTan:Special:User"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "🗑︙ تم مسح  قائمة الاعضاء المميزين  ")
end
if text == "مسح المكتومين" and Addictive(msg) then
database:del(bot_id.."TiTan:Muted:User"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "🗑︙ تم مسح قائمه المكتومين ")
end
if text == "مسح المحظورين" and Addictive(msg) then
database:del(bot_id.."TiTan:Ban:User"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "\n🚷︙تم مسح المحظورين")
end
...
database:sadd(bot_id.."TiTan:GBan:User", result.sender_user_id_)
Kick_Group(result.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","🚫︙تم حظره من مجموعات البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TiTan, nil)
return false
end
if text and text:match("^حظر عام @(.*)$")  and DevTiTan(msg) then
...
database:sadd(bot_id.."TiTan:GBan:User", result.id_)
Reply_Status(msg,result.id_,"reply","🚫︙تم حظره من مجموعات البوت")  
else
...
if text and text:match("^حظر عام (%d+)$") and DevTiTan(msg) then
...
database:sadd(bot_id.."TiTan:GBan:User", userid)
Reply_Status(msg,userid,"reply","🚫︙تم حظره من مجموعات البوت")  
return false
end
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTiTan(msg) then
function Function_TiTan(extra, result, success)
database:srem(bot_id.."TiTan:GBan:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","🚫︙تم الغاء حظره من مجموعات البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TiTan, nil)
return false
end
if text and text:match("^الغاء العام @(.*)$") and DevTiTan(msg) then
local username = text:match("^الغاء العام @(.*)$") 
function Function_TiTan(extra, result, success)
if result.id_ then
Reply_Status(msg,result.id_,"reply","🚫︙تم الغاء حظره من مجموعات البوت")  
...
if text and text:match("^الغاء العام (%d+)$") and DevTiTan(msg) then
local userid = text:match("^الغاء العام (%d+)$")
database:srem(bot_id.."TiTan:GBan:User", userid)
Reply_Status(msg,userid,"reply","🚫︙تم الغاء حظره من مجموعات البوت")  
return false
end
...
function Function_TiTan(extra, result, success)
database:sadd(bot_id.."TiTan:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","🔖︙تم رفعة مطور في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TiTan, nil)
return false 
end
if text and text:match("^رفع مطور @(.*)$") and DevTiTan(msg) then
...
database:sadd(bot_id.."TiTan:Sudo:User", result.id_)
Reply_Status(msg,result.id_,"reply","🔖︙تم رفعة مطور في البوت")  
else
send(msg.chat_id_, msg.id_,"💢︙لا يوجد حساب بهاذا المعرف")
end
end
...
database:sadd(bot_id.."TiTan:Sudo:User", userid)
Reply_Status(msg,userid,"reply","🔖︙تم رفعة مطور في البوت")  
return false 
end
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTiTan(msg) then
function Function_TiTan(extra, result, success)
database:srem(bot_id.."TiTan:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","🔰︙تم تنزيلة مطور من البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TiTan, nil)
return false 
end
if text and text:match("^حذف مطور @(.*)$") and DevTiTan(msg) then
local username = text:match("^حذف مطور @(.*)$")
function Function_TiTan(extra, result, success)
if result.id_ then
database:srem(bot_id.."TiTan:Sudo:User", result.id_)
Reply_Status(msg,result.id_,"reply","🔰︙تم تنزيلة مطور من البوت")  
else
send(msg.chat_id_, msg.id_,"💢︙لا يوجد حساب بهاذا المعرف")
end
end
...
if text and text:match("^حذف مطور (%d+)$") and DevTiTan(msg) then
local userid = text:match("^حذف مطور (%d+)$")
database:srem(bot_id.."TiTan:Sudo:User", userid)
...
database:sadd(bot_id.."TiTan:Basic:Constructor"..msg.chat_id_, result.id_)
Reply_Status(msg,result.id_,"reply","🔖︙تم رفعة منشئ اساسي في البوت")  
else
send(msg.chat_id_, msg.id_,"💢︙لا يوجد حساب بهاذا المعرف")
end
end
...
database:sadd(bot_id.."TiTan:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_TiTan(extra, result, success)
if result.id_ then
database:srem(bot_id.."TiTan:Basic:Constructor"..msg.chat_id_, result.id_)

Reply_Status(msg,result.id_,"reply","🔰︙تم تنزيلة منشئ اساسي من البوت")  
else
send(msg.chat_id_, msg.id_,"💢︙لا يوجد حساب بهاذا المعرف")
end
end
...
database:srem(bot_id.."TiTan:Basic:Constructor"..msg.chat_id_, userid)
...
if text == "مسح المنشئين الاساسين" then
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
if da.status_.ID == "ChatMemberStatusCreator" then
database:del(bot_id.."TiTan:Basic:Constructor"..msg.chat_id_)
texts = "✖︙ تم مسح المنشئين الاساسيين"
...
function Function_TiTan(extra, result, success)
database:sadd(bot_id.."TiTan:Constructor"..msg.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","🔰︙تم رفعه منشئ في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TiTan, nil)
end
...
database:sadd(bot_id.."TiTan:Constructor"..msg.chat_id_, result.id_)
Reply_Status(msg,result.id_,"reply","🔰︙تم رفعه منشئ في البوت")  
else
send(msg.chat_id_, msg.id_,"💢︙لا يوجد حساب بهاذا المعرف")
end
end
...
database:sadd(bot_id.."TiTan:Constructor"..msg.chat_id_, userid)
...
function Function_TiTan(extra, result, success)
if result.id_ then
database:srem(bot_id.."TiTan:Constructor"..msg.chat_id_, result.id_)
Reply_Status(msg,result.id_,"reply","🔰︙تم تنزيلة منشئ من البوت")  
else
send(msg.chat_id_, msg.id_,"💢︙لا يوجد حساب بهاذا المعرف")
end
end
...
database:srem(bot_id.."TiTan:Constructor"..msg.chat_id_, userid)
...
Reply_Status(msg,result.sender_user_id_,"reply","🔖︙تم رفعة مدير في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TiTan, nil)
return false
end  
...
Reply_Status(msg,result.id_,"reply","🔖︙تم رفعة مدير في البوت")  
else
send(msg.chat_id_, msg.id_,"💢︙لا يوجد حساب بهاذا المعرف")
end
end
...
database:sadd(bot_id.."TiTan:Manager"..msg.chat_id_, userid)
...
Reply_Status(msg,result.id_,"reply","🔰︙تم تنزيله مدير من البوت")  
else
send(msg.chat_id_, msg.id_,"💢︙لا يوجد حساب بهاذا المعرف")
end
end
...
database:srem(bot_id.."TiTan:Manager"..msg.chat_id_, userid)
...
Reply_Status(msg,result.sender_user_id_,"reply","🔖︙تم رفعة ادمن في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TiTan, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","🔖︙تم رفعة ادمن في البوت")  
else
send(msg.chat_id_, msg.id_,"💢︙لا يوجد حساب بهاذا المعرف")
end
end
...
database:sadd(bot_id.."TiTan:Mod:User"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","🔖︙تم رفعة ادمن في البوت")  
return false
end
...
Reply_Status(msg,result.id_,"reply","🔰︙تم تنزيلة ادمن من البوت")  
else
send(msg.chat_id_, msg.id_,"💢︙لا يوجد حساب بهاذا المعرف")
end
end
...
database:srem(bot_id.."TiTan:Mod:User"..msg.chat_id_, userid)
...
Reply_Status(msg,result.sender_user_id_,"reply","🔖︙تم رفعة مميز في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TiTan, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","🔖︙تم رفعة مميز في البوت")  
else
send(msg.chat_id_, msg.id_,"💢︙لا يوجد حساب بهاذا المعرف")
end
end
...
function Function_TiTan(extra, result, success)
database:sadd(bot_id.."TiTan:Mote:User"..msg.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","🦓︙تم رفعة مطي في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TiTan, nil)
return false
end
...
database:sadd(bot_id.."TiTan:Mote:User"..msg.chat_id_, result.id_)
Reply_Status(msg,result.id_,"reply","🦓︙تم رفعة مطي في البوت")  
else
send(msg.chat_id_, msg.id_,"💢︙لا يوجد حساب بهاذا المعرف")
end
end
...
function Function_TiTan(extra, result, success)
database:srem(bot_id.."TiTan:Mote:User"..msg.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","🦓︙تم تنزيله من مطي الى انسان")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TiTan, nil)
return false
end
...
function Function_TiTan(extra, result, success)
if result.id_ then
database:srem(bot_id.."TiTan:Mote:User"..msg.chat_id_, result.id_)
Reply_Status(msg,result.id_,"reply","🔰︙تم تنزيله من مطي الى انسان")  
else
send(msg.chat_id_, msg.id_,"💢︙لا يوجد حساب بهاذا المعرف")
end
end
...
database:sadd(bot_id.."TiTan:Special:User"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","🔖︙تم رفعة مميز في البوت")  
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","🔰︙تم تنزيله من المميزين في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TiTan, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","🔰︙تم تنزيله من المميزين في البوت")  
else
send(msg.chat_id_, msg.id_,"💢︙لا يوجد حساب بهاذا المعرف")
end
end
...
database:srem(bot_id.."TiTan:Special:User"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","🔰︙تم تنزيله من المميزين في البوت")  
return false
end  
...
if database:sismember(bot_id.."TiTan:Coomds"..msg.chat_id_,RTPA) then
...
send(msg.chat_id_, msg.id_,"\n💁🏻‍♂️︙العضو ["..data.first_name_.."](t.me/"..(data.username_ or "TiTan")..")".."✓\n📬︙تم رفعه "..RTPA.." في البوت\n")   
...
if database:sismember(bot_id.."TiTan:Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local TiTanrt = database:get(bot_id.."TiTan:Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if TiTanrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n💁🏻‍♂️︙العضو ["..result.title_.."](t.me/"..(text1[3] or "TiTan")..")".."✓\n📬︙تم رفعه "..text1[2].." في البوت ")   
database:sadd(bot_id.."TiTan:Special:User"..msg.chat_id_,result.id_)  
...
database:sadd(bot_id.."TiTan:Ban:User"..msg.chat_id_, result.sender_user_id_)
Kick_Group(result.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."TiTan:Ban:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."TiTan:Ban:User"..msg.chat_id_, userid)
...
Reply_Status(msg,result.sender_user_id_,"reply","📬︙تم الغاء حظره من المجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TiTan, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","📬︙تم الغاء حظره من المجموعه")  
else
send(msg.chat_id_, msg.id_, "💢︙لا يوجد حساب بهاذا المعرف")
end
end
...
database:srem(bot_id.."TiTan:Ban:User"..msg.chat_id_, userid)
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
Reply_Status(msg,userid,"reply","📬︙تم الغاء حظره من المجموعه")  
return false
end
...
database:sadd(bot_id.."TiTan:Muted:User"..msg.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","📬︙تم كتمه من المجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TiTan, nil)
return false
end
...
database:sadd(bot_id.."TiTan:Muted:User"..msg.chat_id_, result.id_)
Reply_Status(msg,result.id_,"reply","📬︙تم كتمه من البوت")  
else
send(msg.chat_id_, msg.id_, "💢︙لا يوجد حساب بهاذا المعرف")
end
end
...
database:sadd(bot_id.."TiTan:Muted:User"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","📬︙تم كتمه من البوت")  
end
return false
end
...
Reply_Status(msg,result.id_,"reply","📬︙تم الغاء كتمه من المجموعه ")  
else
send(msg.chat_id_, msg.id_,"💢︙لا يوجد حساب بهاذا المعرف")
end
end
...
database:srem(bot_id.."TiTan:Muted:User"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","📬︙تم الغاء كتمه من المجموعه ")  
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","📛 ※ تم تقيده في المجموعه")  
end
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TiTan, nil)
return false
...
Reply_Status(msg,result.id_,"reply","📛 ※ تم تقيده في المجموعه")  
else
send(msg.chat_id_, msg.id_,"💢︙لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","📛 ※ تم تقيده في المجموعه")  
end
return false
end
------------------------------------------------------------------------
...
Reply_Status(msg,result.id_,"reply","📛 ※ تم الغاء تقيده من المجموعه")  
else
send(msg.chat_id_, msg.id_, "💢︙لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","📛 ※ تم الغاء تقيده من المجموعه")  
return false
end
...
Kick_Group(result.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","📬︙تم طرده من المجموعه ")  
end,nil)
end
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TiTan, nil)
...
Kick_Group(msg.chat_id_, result.id_)
Reply_Status(msg,result.id_,"reply","📬︙تم طرده من المجموعه ")  
end,nil)   
end
else
send(msg.chat_id_, msg.id_, "💢︙لا يوجد حساب بهاذا المعرف")
...
Kick_Group(msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","📬︙تم طرده من المجموعه ")  
end,nil)   
end
return false
end
...
if database:sismember(bot_id.."TiTan:Lock:pin",msg.chat_id_) and not Constructor(msg) then
...
database:set(bot_id.."TiTan:Pin:Id:Msg"..msg.chat_id_,msg.reply_to_message_id_)
...
database:del(bot_id.."TiTan:Pin:Id:Msg"..msg.chat_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"💢︙انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"??︙ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
...
database:hset(bot_id.."TiTan:flooding:settings:"..msg.chat_id_ ,"floodmax" ,Num) 
...
database:hset(bot_id.."TiTan:flooding:settings:"..msg.chat_id_ ,"floodtime" ,Num) 
...
database:setex(bot_id.."TiTan:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_,120,true) 
return false
end
end
...
if text == "الرابط" then 
local status_Link = database:get(bot_id.."TiTan:Link_Group"..msg.chat_id_)
if not status_Link then
send(msg.chat_id_, msg.id_,"☑︙جلب الرابط معطل") 
return false  
end
local link = database:get(bot_id.."TiTan:Private:Group:Link"..msg.chat_id_)            
if link then                              
...
if Addictive(msg) then     
send(msg.chat_id_,msg.id_,"☑︙تم مسح رابط المجموعة")           
database:del(bot_id.."TiTan:Private:Group:Link"..msg.chat_id_) 
return false      
end
return false  
end
...
database:set(bot_id.."TiTan:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_,true) 
...
if Addictive(msg) then
database:setex(bot_id.."TiTan:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if database:get(bot_id.."TiTan:Get:Welcome:Group"..msg.chat_id_)   then 
Welcome = database:get(bot_id.."TiTan:Get:Welcome:Group"..msg.chat_id_)  
else 
...
database:del(bot_id.."TiTan:Chek:Welcome"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"☑︙تم تعطيل ترحيب المجموعه") 
return false  
end
if text == "مسح الترحيب" or text == "حذف الترحيب" then 
if Addictive(msg) then
database:del(bot_id.."TiTan:Get:Welcome:Group"..msg.chat_id_) 
...
for k,v in pairs(list) do  
database:del(bot_id.."TiTan:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TiTan:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."TiTan:List:Filter"..msg.chat_id_,v)  
end  
...
database:set(bot_id.."TiTan:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."TiTan:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"📫︙ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."TiTan:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."TiTan:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."TiTan:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."TiTan:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"📬︙تم منع الكلمه مع التحذير")  
database:del(bot_id.."TiTan:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."TiTan:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."TiTan:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."TiTan:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Addictive(msg) then    
send(msg.chat_id_, msg.id_,"📬︙ارسل الكلمه الان")  
database:set(bot_id.."TiTan:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."TiTan:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."TiTan:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TiTan:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."TiTan:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
if database:get(bot_id.."TiTan:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_, "☑︙تم الغاء حفظ القوانين") 
database:del(bot_id.."TiTan:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."TiTan:Set:Rules:Group" .. msg.chat_id_,text) 
...
if Addictive(msg) then
database:setex(bot_id.."TiTan:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:del(bot_id.."TiTan:Set:Rules:Group"..msg.chat_id_) 
end
end
if text == "القوانين" then 
local Set_Rules = database:get(bot_id.."TiTan:Set:Rules:Group" .. msg.chat_id_)   
if Set_Rules then     
...
local list = database:smembers(bot_id.."TiTan:List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."TiTan:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
database:del(bot_id.."TiTan:List:Cmd:Group:New"..msg.chat_id_)
end
...
if Constructor(msg) then
database:set(bot_id.."TiTan:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
local list = database:smembers(bot_id.."TiTan:Coomds"..msg.chat_id_)
if #list == 0 then
...
local list = database:smembers(bot_id.."TiTan:Coomds"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."TiTan:Comd:New:rt:bot:"..v..msg.chat_id_)
database:del(bot_id.."TiTan:Coomds"..msg.chat_id_)
end
...
database:sadd(bot_id.."TiTan:Coomds"..msg.chat_id_,ComdNew)  
database:setex(bot_id.."TiTan:Comd:New"..msg.chat_id_..""..msg.sender_user_id_,200,true)  
...
if database:get(bot_id.."TiTan:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,"☑︙تم الغاء الامر ") 
database:del(bot_id.."TiTan:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = database:get(bot_id.."TiTan:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
database:set(bot_id.."TiTan:Comd:New:rt:bot:"..textn..msg.chat_id_,text)
...
for k,v in pairs(list) do
database:del(bot_id.."TiTan:Add:Rd:Manager:Gif"..v..msg.chat_id_)   
database:del(bot_id.."TiTan:Add:Rd:Manager:Vico"..v..msg.chat_id_)   
database:del(bot_id.."TiTan:Add:Rd:Manager:Stekrs"..v..msg.chat_id_)     
database:del(bot_id.."TiTan:Add:Rd:Manager:Text"..v..msg.chat_id_)   
database:del(bot_id.."TiTan:Add:Rd:Manager:Photo"..v..msg.chat_id_)
database:del(bot_id.."TiTan:Add:Rd:Manager:Video"..v..msg.chat_id_)
database:del(bot_id.."TiTan:Add:Rd:Manager:File"..v..msg.chat_id_)
...
db = "متحركه 🎭"
elseif database:get(bot_id.."TiTan:Add:Rd:Manager:Vico"..v..msg.chat_id_) then
db = "بصمه 📢"
elseif database:get(bot_id.."TiTan:Add:Rd:Manager:Stekrs"..v..msg.chat_id_) then
db = "ملصق 🃏"
elseif database:get(bot_id.."TiTan:Add:Rd:Manager:Text"..v..msg.chat_id_) then
db = "رساله ✉"
elseif database:get(bot_id.."TiTan:Add:Rd:Manager:Photo"..v..msg.chat_id_) then
db = "صوره 🎇"
elseif database:get(bot_id.."TiTan:Add:Rd:Manager:Video"..v..msg.chat_id_) then
db = "فيديو 📹"
elseif database:get(bot_id.."TiTan:Add:Rd:Manager:File"..v..msg.chat_id_) then
db = "ملف 📁"
...
local test = database:get(bot_id.."TiTan:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_.."")
if database:get(bot_id.."TiTan:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."TiTan:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."TiTan:Add:Rd:Manager:Stekrs"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."TiTan:Add:Rd:Manager:Vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."TiTan:Add:Rd:Manager:Gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."TiTan:Add:Rd:Manager:Text"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."TiTan:Add:Rd:Manager:Audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."TiTan:Add:Rd:Manager:File"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."TiTan:Add:Rd:Manager:Video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
database:set(bot_id.."TiTan:Add:Rd:Manager:Photo"..test..msg.chat_id_, photo_in_group)  
end
...
database:set(bot_id.."TiTan:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
...
database:set(bot_id.."TiTan:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true2")
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."TiTan:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '📥︙الان ارسل الرد الذي تريد اضافته \n📥︙ قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n☑︙ يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."TiTan:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true1")
database:set(bot_id.."TiTan:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:del(bot_id.."TiTan:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."TiTan:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."TiTan:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."TiTan:Add:Rd:Manager:Text"..text..msg.chat_id_)   
database:del(bot_id.."TiTan:Add:Rd:Manager:Photo"..text..msg.chat_id_)
database:del(bot_id.."TiTan:Add:Rd:Manager:Video"..text..msg.chat_id_)
database:del(bot_id.."TiTan:Add:Rd:Manager:File"..text..msg.chat_id_)
database:del(bot_id.."TiTan:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:sadd(bot_id.."TiTan:List:Manager"..msg.chat_id_.."", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."TiTan:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_.."") == "true2" then
...
database:del(bot_id.."TiTan:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:del(bot_id.."TiTan:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."TiTan:List:Manager"..msg.chat_id_.."", text)
return false
end
end
if text and not database:get(bot_id.."TiTan:Reply:Manager"..msg.chat_id_) then
if not database:sismember(bot_id..'TiTan:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."TiTan:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
local veico = database:get(bot_id.."TiTan:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
local stekr = database:get(bot_id.."TiTan:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
local Text = database:get(bot_id.."TiTan:Add:Rd:Manager:Text"..text..msg.chat_id_)   
local photo = database:get(bot_id.."TiTan:Add:Rd:Manager:Photo"..text..msg.chat_id_)
local video = database:get(bot_id.."TiTan:Add:Rd:Manager:Video"..text..msg.chat_id_)
local document = database:get(bot_id.."TiTan:Add:Rd:Manager:File"..text..msg.chat_id_)
local audio = database:get(bot_id.."TiTan:Add:Rd:Manager:Audio"..text..msg.chat_id_)
if Text then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,data)
local NumMsg = database:get(bot_id..'TiTan:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'TiTan:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
...
------------------------------------------------------------------------
if text == ("مسح ردود المطور") and DevTiTan(msg) then 
local list = database:smembers(bot_id.."TiTan:List:Rd:Sudo")
for k,v in pairs(list) do
database:del(bot_id.."TiTan:Add:Rd:Sudo:Gif"..v)   
database:del(bot_id.."TiTan:Add:Rd:Sudo:vico"..v)   
database:del(bot_id.."TiTan:Add:Rd:Sudo:stekr"..v)     
database:del(bot_id.."TiTan:Add:Rd:Sudo:Text"..v)   
database:del(bot_id.."TiTan:Add:Rd:Sudo:Photo"..v)
database:del(bot_id.."TiTan:Add:Rd:Sudo:Video"..v)
database:del(bot_id.."TiTan:Add:Rd:Sudo:File"..v)
database:del(bot_id.."TiTan:Add:Rd:Sudo:Audio"..v)
database:del(bot_id.."TiTan:List:Rd:Sudo")
end
...
db = "متحركه 🎭"
elseif database:get(bot_id.."TiTan:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif database:get(bot_id.."TiTan:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif database:get(bot_id.."TiTan:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif database:get(bot_id.."TiTan:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif database:get(bot_id.."TiTan:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif database:get(bot_id.."TiTan:Add:Rd:Sudo:File"..v) then
db = "ملف 📁"
...
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local test = database:get(bot_id.."TiTan:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."TiTan:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."TiTan:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."TiTan:Add:Rd:Sudo:stekr"..test, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."TiTan:Add:Rd:Sudo:vico"..test, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."TiTan:Add:Rd:Sudo:Gif"..test, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."TiTan:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."TiTan:Add:Rd:Sudo:Audio"..test, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."TiTan:Add:Rd:Sudo:File"..test, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."TiTan:Add:Rd:Sudo:Video"..test, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
database:set(bot_id.."TiTan:Add:Rd:Sudo:Photo"..test, photo_in_group)  
end
send(msg.chat_id_, msg.id_,"📌︙تم حفظ الرد بنجاح")
return false  
end  
...
send(msg.chat_id_, msg.id_,"📥︙ ارسل الكلمه التي تريد اضافتها")
database:set(bot_id.."TiTan:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and DevTiTan(msg) then 
send(msg.chat_id_, msg.id_,"📫︙ ارسل الكلمه التي تريد حذفها")
database:set(bot_id.."TiTan:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."TiTan:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '📥︙الان ارسل الرد الذي تريد اضافته \n📥︙ قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n☑︙ يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."TiTan:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."TiTan:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."TiTan:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."TiTan:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"📌︙تم ازالة الرد من قائمه ردود المطور")
list = {"Add:Rd:Sudo:Audio","Add:Rd:Sudo:File","Add:Rd:Sudo:Video","Add:Rd:Sudo:Photo","Add:Rd:Sudo:Text","Add:Rd:Sudo:stekr","Add:Rd:Sudo:vico","Add:Rd:Sudo:Gif"}
for k,v in pairs(list) do
database:del(bot_id..'TiTan:'..v..text)
end
database:del(bot_id.."TiTan:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."TiTan:List:Rd:Sudo", text)
return false
end
end

if text and not database:get(bot_id.."TiTan:Reply:Sudo"..msg.chat_id_) then
if not database:sismember(bot_id..'TiTan:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."TiTan:Add:Rd:Sudo:Gif"..text)   
local veico = database:get(bot_id.."TiTan:Add:Rd:Sudo:vico"..text)   
local stekr = database:get(bot_id.."TiTan:Add:Rd:Sudo:stekr"..text)     
local Text = database:get(bot_id.."TiTan:Add:Rd:Sudo:Text"..text)   
local photo = database:get(bot_id.."TiTan:Add:Rd:Sudo:Photo"..text)
local video = database:get(bot_id.."TiTan:Add:Rd:Sudo:Video"..text)
local document = database:get(bot_id.."TiTan:Add:Rd:Sudo:File"..text)
local audio = database:get(bot_id.."TiTan:Add:Rd:Sudo:Audio"..text)
...
if not database:get(bot_id.."TiTan:Kick:Me"..msg.chat_id_) then
...
database:del(bot_id.."TiTan:Kick:Me"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,Text) 
end
if text == "تعطيل اطردني" and Owner(msg) then  
database:set(bot_id.."TiTan:Kick:Me"..msg.chat_id_,true)  
Text = "\n☑︙تم تعطيل امر اطردني"
send(msg.chat_id_, msg.id_,Text) 
end
...
database:srem(bot_id.."TiTan:Ban:User"..msg.chat_id_,result.id_)
database:srem(bot_id.."TiTan:Muted:User"..msg.chat_id_,result.id_)
usertext = "\n💁🏻‍♂️︙العضو  ~⪼ ["..result.title_.."](t.me/"..(username or "kenwa")..")"
status  = "\n📬︙تم الغاء القيود عنه  "
...
database:srem(bot_id.."TiTan:Ban:User"..msg.chat_id_,result.id_)
database:srem(bot_id.."TiTan:Muted:User"..msg.chat_id_,result.id_)
Reply_Status(msg,result.id_,"reply","📬︙تم الغاء القيود عنه  ")  
end
else
Text = "📫︙ المعرف غلط"
send(msg.chat_id_, msg.id_,Text)
...
database:srem(bot_id.."TiTan:Ban:User"..msg.chat_id_,result.sender_user_id_)
database:srem(bot_id.."TiTan:Muted:User"..msg.chat_id_,result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","📬︙تم الغاء القيود عنه  ")  
else
database:srem(bot_id.."TiTan:Ban:User"..msg.chat_id_,result.sender_user_id_)
database:srem(bot_id.."TiTan:Muted:User"..msg.chat_id_,result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = "\n💁🏻‍♂️︙العضو  ["..data.first_name_.."](t.me/"..(data.username_ or "kenwa").."✓)"
status  = "\n📬︙تم الغاء القيود عنه  "
...
function Function_TiTan(extra, result, success)
if result.id_ then
if database:sismember(bot_id.."TiTan:Muted:User"..msg.chat_id_,result.id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."TiTan:Ban:User"..msg.chat_id_,result.id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."TiTan:GBan:User",result.id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
function Function_TiTan(extra, result, success)
if database:sismember(bot_id.."TiTan:Muted:User"..msg.chat_id_,result.sender_user_id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."TiTan:Ban:User"..msg.chat_id_,result.sender_user_id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."TiTan:GBan:User",result.sender_user_id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
database:sadd(bot_id.."TiTan:Mod:User"..msg.chat_id_, admins[i].user_id_)
num2 = num2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,b) 
if b.username_ == true then
end
if b.first_name_ == false then
database:srem(bot_id.."TiTan:Mod:User"..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
database:srem(bot_id.."TiTan:Mod:User"..msg.chat_id_, admins[i].user_id_)
...
local UserName = (b.username_ or "TiTan")
...
database:sadd(bot_id.."TiTan:Basic:Constructor"..msg.chat_id_,b.id_)
end,nil)   
end,nil)   
end

if text == "غادر" then 
if DevBot(msg) and not database:get(bot_id.."TiTan:Left:Bot"..msg.chat_id_) then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,"📫︙ تم مغادرة المجموعه") 
database:srem(bot_id.."TiTan:Chek:Groups",msg.chat_id_)  
end
return false  
end
...
database:srem(bot_id.."TiTan:Chek:Groups",GP_ID[2])  
return false 
end
end
if text == "تفعيل المغادره" and DevTiTan(msg) then   
database:del(bot_id.."TiTan:Left:Bot"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"☑︙تم تفعيل مغادرة البوت") 
return false 
end
if text == "تعطيل المغادره" and DevTiTan(msg) then  
database:set(bot_id.."TiTan:Left:Bot"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_, "☑︙تم تعطيل مغادرة البوت") 
return false 
end
if text == (database:get(bot_id.."TiTan:Name:Bot") or "TiTan") then
...
if database:get(bot_id.."TiTan:Status:Bc") and not DevTiTan(msg) then 
send(msg.chat_id_, msg.id_,"📫︙الاذاعه معطله من قبل المطور الاساسي")
return false
end
database:setex(bot_id.."TiTan:TiTan:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."TiTan:TiTan:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"📬︙ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n📫︙للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."TiTan:TiTan:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."TiTan:TiTan:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"📥︙ارسل لي التوجيه الان") 
return false
end 

if text == "تفعيل الاذاعه" and DevTiTan(msg) then  
database:del(bot_id.."TiTan:Status:Bc") 
send(msg.chat_id_, msg.id_,"\n☑︙تم تفعيل الاذاعه " ) 
return false
end 
if text == "تعطيل الاذاعه" and DevTiTan(msg) then  
database:set(bot_id.."TiTan:Status:Bc",true) 
send(msg.chat_id_, msg.id_,"\n☑︙تم تعطيل الاذاعه") 
return false
end 

if text == "الاعدادات" and Addictive(msg) then    
if database:get(bot_id.."TiTan:lockpin"..msg.chat_id_) then    
lock_pin = "✓"
else 
lock_pin = "✘"    
end
if database:get(bot_id.."TiTan:Lock:tagservr"..msg.chat_id_) then    
lock_tagservr = "✓"
else 
lock_tagservr = "✘"    
end
if database:get(bot_id.."TiTan:Lock:text"..msg.chat_id_) then    
lock_text = "✓"
else 
lock_text = "✘"    
end
...
if database:get(bot_id.."TiTan:Lock:edit"..msg.chat_id_) then    
lock_edit = "✓"
else 
lock_edit = "✘"    
end
...
if database:hget(bot_id.."TiTan:flooding:settings:"..msg.chat_id_, "flood") == "kick" then     
flood = "بالطرد"     
elseif database:hget(bot_id.."TiTan:flooding:settings:"..msg.chat_id_,"flood") == "keed" then     
flood = "بالتقيد"     
elseif database:hget(bot_id.."TiTan:flooding:settings:"..msg.chat_id_,"flood") == "mute" then     
flood = "بالكتم"           
elseif database:hget(bot_id.."TiTan:flooding:settings:"..msg.chat_id_,"flood") == "del" then     
flood = "بالمسح"           
else     
flood = "✘"     
end
...
if database:get(bot_id.."TiTan:Lock:Link"..msg.chat_id_) == "del" then
lock_links = "✓"
elseif database:get(bot_id.."TiTan:Lock:Link"..msg.chat_id_) == "ked" then
lock_links = "بالتقيد"    
elseif database:get(bot_id.."TiTan:Lock:Link"..msg.chat_id_) == "ktm" then
lock_links = "بالكتم"    
elseif database:get(bot_id.."TiTan:Lock:Link"..msg.chat_id_) == "kick" then
lock_links = "بالطرد"    
else
lock_links = "✘"    
end
if database:get(bot_id.."TiTan:Lock:Cmd"..msg.chat_id_) == "del" then
lock_cmds = "✓"
elseif database:get(bot_id.."TiTan:Lock:Cmd"..msg.chat_id_) == "ked" then
lock_cmds = "بالتقيد"    
elseif database:get(bot_id.."TiTan:Lock:Cmd"..msg.chat_id_) == "ktm" then
lock_cmds = "بالكتم"   
elseif database:get(bot_id.."TiTan:Lock:Cmd"..msg.chat_id_) == "kick" then
lock_cmds = "بالطرد"    
else
lock_cmds = "✘"    
end
if database:get(bot_id.."TiTan:Lock:User:Name"..msg.chat_id_) == "del" then
lock_user = "✓"
elseif database:get(bot_id.."TiTan:Lock:User:Name"..msg.chat_id_) == "ked" then
lock_user = "بالتقيد"    
elseif database:get(bot_id.."TiTan:Lock:User:Name"..msg.chat_id_) == "ktm" then
lock_user = "بالكتم"    
elseif database:get(bot_id.."TiTan:Lock:User:Name"..msg.chat_id_) == "kick" then
lock_user = "بالطرد"    
else
lock_user = "✘"    
end
if database:get(bot_id.."TiTan:Lock:hashtak"..msg.chat_id_) == "del" then
lock_hash = "✓"
elseif database:get(bot_id.."TiTan:Lock:hashtak"..msg.chat_id_) == "ked" then 
lock_hash = "بالتقيد"    
elseif database:get(bot_id.."TiTan:Lock:hashtak"..msg.chat_id_) == "ktm" then 
lock_hash = "بالكتم"    
elseif database:get(bot_id.."TiTan:Lock:hashtak"..msg.chat_id_) == "kick" then 
lock_hash = "بالطرد"    
else
lock_hash = "✘"    
end
...
if database:get(bot_id.."TiTan:Lock:Bot:kick"..msg.chat_id_) == "del" then
lock_bots = "✓"
elseif database:get(bot_id.."TiTan:Lock:Bot:kick"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif database:get(bot_id.."TiTan:Lock:Bot:kick"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "✘"    
end
...
if database:get(bot_id.."TiTan:Lock:Spam"..msg.chat_id_) == "del" then    
lock_spam = "✓"
elseif database:get(bot_id.."TiTan:Lock:Spam"..msg.chat_id_) == "ked" then 
lock_spam = "بالتقيد"    
elseif database:get(bot_id.."TiTan:Lock:Spam"..msg.chat_id_) == "ktm" then 
lock_spam = "بالكتم"    
elseif database:get(bot_id.."TiTan:Lock:Spam"..msg.chat_id_) == "kick" then 
lock_spam = "بالطرد"    
else
lock_spam = "✘"    
end        
if not database:get(bot_id.."TiTan:Reply:Manager"..msg.chat_id_) then
rdmder = "✓"
else
rdmder = "✘"
end
if not database:get(bot_id.."TiTan:Reply:Sudo"..msg.chat_id_) then
rdsudo = "✓"
else
rdsudo = "✘"
end
if not database:get(bot_id.."TiTan:Lock:ID:Bot"..msg.chat_id_)  then
idgp = "✓"
else
idgp = "✘"
end
if not database:get(bot_id.."TiTan:Lock:ID:Bot:Photo"..msg.chat_id_) then
idph = "✓"
else
idph = "✘"
end
if not database:get(bot_id.."TiTan:Lock:kick"..msg.chat_id_)  then
setadd = "✓"
else
setadd = "✘"
end
if not database:get(bot_id.."TiTan:Lock:Add:Bot"..msg.chat_id_)  then
banm = "✓"
else
banm = "✘"
end
...
database:set(bot_id.."TiTan:Fun_Bots"..msg.chat_id_,"true")
end
if text == "تفعيل اوامر التحشيش" and Owner(msg) then    
send(msg.chat_id_, msg.id_,'☑︙تم تفعيل اوامر التحشيش')
database:del(bot_id.."TiTan:Fun_Bots"..msg.chat_id_)
end
...
database:set(bot_id..'TiTan:Lock:ID:Bot'..msg.chat_id_,true) 
...
database:set(bot_id..'TiTan:Lock:ID:Bot:Photo'..msg.chat_id_,true) 
...
if Owner(msg) then
database:del(bot_id.."TiTan:Klesh:Id:Bot"..msg.chat_id_)
send(msg.chat_id_, msg.id_, '📌︙تم ازالة كليشة الايدي ')
end
return false  
end 

if database:get(bot_id.."TiTan:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"☑︙تم الغاء تعين الايدي") 
database:del(bot_id.."TiTan:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."TiTan:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
database:set(bot_id.."TiTan:Klesh:Id:Bot"..msg.chat_id_,text:match("(.*)"))
...
local message_edit = database:get(bot_id..'TiTan:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Num_Games = database:get(bot_id.."TiTan:Add:Num"..msg.chat_id_..msg.sender_user_id_) or 0
local Add_Mem = database:get(bot_id.."TiTan:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
...
local get_id = database:get(bot_id.."TiTan:Klesh:Id:Bot"..msg.chat_id_)
if not database:get(bot_id..'TiTan:Lock:ID:Bot:Photo'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_,'📮︙لا تستطيع تنضيف اكثر من *~ 10000* رساله') 
return false  
end  
...
local Id = data.id_
local NumMsg = database:get(bot_id..'TiTan:messageUser'..msg.chat_id_..':'..data.id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'TiTan:message_edit'..msg.chat_id_..data.id_) or 0
local Num_Games = database:get(bot_id.."TiTan:Msg_User"..msg.chat_id_..":"..data.id_) or 0
local Add_Mem = database:get(bot_id.."TiTan:Add:Memp"..msg.chat_id_..":"..data.id_) or 0
...
if text and text:match("^ايدي @(.*)$") and not database:get(bot_id..'TiTan:Lock:ID:Bot'..msg.chat_id_) then
...
database:set(bot_id.."TiTan:Random:Sm"..msg.chat_id_,SM)
send(msg.chat_id_, msg.id_,"🔰︙اسرع واحد يدز هاذا السمايل ? ~ {`"..SM.."`}")
return false
end
end
if text == ""..(database:get(bot_id.."TiTan:Random:Sm"..msg.chat_id_) or "").."" and not database:get(bot_id.."TiTan:Set:Sma"..msg.chat_id_) then
if not database:get(bot_id.."TiTan:Set:Sma"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"🎁︙الف مبروك لقد فزت \n♻︙للعب مره اخره ارسل ~{ سمايل , سمايلات }")
database:incrby(bot_id.."TiTan:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."TiTan:Set:Sma"..msg.chat_id_,true)
return false
end 
if text == "الاسرع" or tect == "ترتيب" then
if database:get(bot_id.."TiTan:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."TiTan:Speed:Tr"..msg.chat_id_)
KlamSpeed = {"سحور","سياره","استقبال","قنفه","ايفون","بزونه","مطبخ","كرستيانو","دجاجه","مدرسه","الوان","غرفه","ثلاجه","كهوه","سفينه","العراق","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمون","فرنسا","برتقاله","تفاح","مطرقه","بتيته","لهانه","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنيت","ساحه","جسر"};
name = KlamSpeed[math.random(#KlamSpeed)]
database:set(bot_id.."TiTan:Klam:Speed"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."TiTan:Klam:Speed"..msg.chat_id_) or "").."" and not database:get(bot_id.."TiTan:Speed:Tr"..msg.chat_id_) then
if not database:get(bot_id.."TiTan:Speed:Tr"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"🎁︙الف مبروك لقد فزت \n♻︙للعب مره اخره ارسل ~{ الاسرع , ترتيب }")
database:incrby(bot_id.."TiTan:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."TiTan:Speed:Tr"..msg.chat_id_,true)
end 

if text == "حزوره" then
if database:get(bot_id.."TiTan:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."TiTan:Set:Hzora"..msg.chat_id_)
Hzora = {"الجرس","عقرب الساعه","السمك","المطر","5","الكتاب","البسمار","7","الكعبه","بيت الشعر","لهانه","انا","امي","الابره","الساعه","22","غلط","كم الساعه","البيتنجان","البيض","المرايه","الضوء","الهواء","الضل","العمر","القلم","المشط","الحفره","البحر","الثلج","الاسفنج","الصوت","بلم"};
name = Hzora[math.random(#Hzora)]
database:set(bot_id.."TiTan:Klam:Hzor"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."TiTan:Klam:Hzor"..msg.chat_id_) or "").."" and not database:get(bot_id.."TiTan:Set:Hzora"..msg.chat_id_) then
if not database:get(bot_id.."TiTan:Set:Hzora"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"🎁︙الف مبروك لقد فزت \n♻︙للعب مره اخره ارسل ~{ حزوره }")
database:incrby(bot_id.."TiTan:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."TiTan:Set:Hzora"..msg.chat_id_,true)
end 

if text == "معاني" then
if database:get(bot_id.."TiTan:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."TiTan:Set:Maany"..msg.chat_id_)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
database:set(bot_id.."TiTan:Maany"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."TiTan:Maany"..msg.chat_id_) or "").."" and not database:get(bot_id.."TiTan:Set:Maany"..msg.chat_id_) then
if not database:get(bot_id.."TiTan:Set:Maany"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"🎁︙الف مبروك لقد فزت \n♻︙للعب مره اخره ارسل ~{ معاني }")
database:incrby(bot_id.."TiTan:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."TiTan:Set:Maany"..msg.chat_id_,true)
end 
if text == "العكس" then
if database:get(bot_id.."TiTan:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."TiTan:Set:Aks"..msg.chat_id_)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
database:set(bot_id.."TiTan:Set:Aks:Game"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."TiTan:Set:Aks:Game"..msg.chat_id_) or "").."" and not database:get(bot_id.."TiTan:Set:Aks"..msg.chat_id_) then
if not database:get(bot_id.."TiTan:Set:Aks"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"🎁︙الف مبروك لقد فزت \n♻︙للعب مره اخره ارسل ~{ العكس }")
database:incrby(bot_id.."TiTan:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."TiTan:Set:Aks"..msg.chat_id_,true)
end 

if database:get(bot_id.."TiTan:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
send(msg.chat_id_, msg.id_,"📬︙عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n")
return false  end 
local GETNUM = database:get(bot_id.."TiTan:GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
database:del(bot_id.."TiTan:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)
database:del(bot_id.."TiTan:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
database:incrby(bot_id.."TiTan:Add:Num"..msg.chat_id_..msg.sender_user_id_,5)  
send(msg.chat_id_, msg.id_,"🔖︙مبروك فزت ويانه وخمنت الرقم الصحيح\n🔰︙تم اضافة { 5 } من النقاط \n")
elseif tonumber(NUM) ~= tonumber(GETNUM) then
database:incrby(bot_id.."TiTan:SADD:NUM"..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(database:get(bot_id.."TiTan:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)) >= 3 then
database:del(bot_id.."TiTan:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)
database:del(bot_id.."TiTan:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
database:set(bot_id.."TiTan:GAMES:NUM"..msg.chat_id_,Num) 
send(msg.chat_id_, msg.id_,"\n📛︙اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n".."💢︙ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n".."🔖︙سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ")
database:setex(bot_id.."TiTan:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
end

if database:get(bot_id.."TiTan:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
send(msg.chat_id_, msg.id_,"📬︙عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخرى\n")
return false  end 
local GETNUM = database:get(bot_id.."TiTan:Games:Bat"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
database:del(bot_id.."TiTan:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,"📮︙مبروك فزت وطلعت المحيبس بل ايد رقم { "..NUM.." }\n🎊︙لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل ")
database:incrby(bot_id.."TiTan:Add:Num"..msg.chat_id_..msg.sender_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
database:del(bot_id.."TiTan:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
if database:get(bot_id.."TiTan:Lock:Games"..msg.chat_id_) then   
Num = math.random(1,6)
database:set(bot_id.."TiTan:Games:Bat"..msg.chat_id_,Num) 
TEST = [[
*➀       ➁     ➂      ➃      ➄     ➅
↓      ↓     ↓      ↓     ↓     ↓
👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊
...
database:setex(bot_id.."TiTan:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
end
...
if text == ""..(database:get(bot_id.."TiTan::Set:Moktlf"..msg.chat_id_) or "").."" then 
if not database:get(bot_id.."TiTan:Set:Moktlf:Bot"..msg.chat_id_) then 
database:del(bot_id.."TiTan::Set:Moktlf"..msg.chat_id_)
send(msg.chat_id_, msg.id_,"🎁︙الف مبروك لقد فزت \n♻︙للعب مره اخره ارسل ~{ المختلف }")
database:incrby(bot_id.."TiTan:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."TiTan:Set:Moktlf:Bot"..msg.chat_id_,true)
end
if text == "امثله" then
if database:get(bot_id.."TiTan:Lock:Games"..msg.chat_id_) then
mthal = {"جوز","ضراطه","الحبل","الحافي","شقره","بيدك","سلايه","النخله","الخيل","حداد","المبلل","يركص","قرد","العنب","العمه","الخبز","بالحصاد","شهر","شكه","يكحله",};
name = mthal[math.random(#mthal)]
database:set(bot_id.."TiTan:Set:Amth"..msg.chat_id_,name)
database:del(bot_id.."TiTan:Set:Amth:Bot"..msg.chat_id_)
...
if text == ""..(database:get(bot_id.."TiTan:Set:Amth"..msg.chat_id_) or "").."" then 
if not database:get(bot_id.."TiTan:Set:Amth:Bot"..msg.chat_id_) then 
database:del(bot_id.."TiTan:Set:Amth"..msg.chat_id_)
send(msg.chat_id_, msg.id_,"🎁︙الف مبروك لقد فزت \n♻︙للعب مره اخره ارسل ~{ امثله }")
database:incrby(bot_id.."TiTan:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."TiTan:Set:Amth:Bot"..msg.chat_id_,true)
end
if text == "تعطيل الالعاب" and Owner(msg) then   
database:del(bot_id.."TiTan:Lock:Games"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"\n☑︙تم تعطيل الالعاب") 
end
...
local Num = database:get(bot_id.."TiTan:Add:Num"..msg.chat_id_..msg.sender_user_id_) or 0
if Num == 0 then 
...
if tonumber(database:get(bot_id.."TiTan:Add:Num"..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
send(msg.chat_id_,msg.id_,"🔖︙ليس لديك جواهر من الالعاب \n📬︙اذا كنت تريد ربح الجواهر \n📌︙ارسل الالعاب وابدأ اللعب ! ") 
else
local NUM_GAMES = database:get(bot_id.."TiTan:Add:Num"..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,"\n💢︙ليس لديك جواهر بهاذا العدد \n📬︙لزيادة مجوهراتك في اللعبه \n📌︙ارسل الالعاب وابدأ اللعب !") 
return false 
end
local NUMNKO = (NUMPY * 50)
database:decrby(bot_id.."TiTan:Add:Num"..msg.chat_id_..msg.sender_user_id_,NUMPY)  
database:incrby(bot_id.."TiTan:messageUser"..msg.chat_id_..":"..msg.sender_user_id_,NUMNKO)  
...
if database:get(bot_id.."TiTan:numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
database:del(bot_id.."TiTan:id:user"..msg.chat_id_)  
send(msg.chat_id_, msg.id_, "📮︙تم الغاء الامر ") 
database:del(bot_id.."TiTan:numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."TiTan:numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = database:get(bot_id.."TiTan:id:user"..msg.chat_id_)  
database:del(bot_id.."TiTan:Msg_User"..msg.chat_id_..":"..msg.sender_user_id_) 
database:incrby(bot_id.."TiTan:messageUser"..msg.chat_id_..":"..iduserr,numadded)  
send(msg.chat_id_, msg.id_,"☑︙تم اضافة له {"..numadded.."} من الرسائل")  
end
if database:get(bot_id.."TiTan:gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
database:del(bot_id.."TiTan:idgem:user"..msg.chat_id_)  
send(msg.chat_id_, msg.id_, "☑︙تم الغاء الامر ") 
database:del(bot_id.."TiTan:gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."TiTan:gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = database:get(bot_id.."TiTan:idgem:user"..msg.chat_id_)  
database:incrby(bot_id.."TiTan:Add:Num"..msg.chat_id_..iduserr,numadded)  
send(msg.chat_id_, msg.id_,"☑︙تم اضافة له {"..numadded.."} من المجوهرات")  
end
------------------------------------------------------------
if text and text:match("^اضف رسائل (%d+)$") and msg.reply_to_message_id_ == 0 and Constructor(msg) then    
taha = text:match("^اضف رسائل (%d+)$")
database:set(bot_id.."TiTan:id:user"..msg.chat_id_,taha)  
database:setex(bot_id.."TiTan:numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
database:set(bot_id.."TiTan:idgem:user"..msg.chat_id_,taha)  
database:setex(bot_id.."TiTan:gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
database:incrby(bot_id.."TiTan:Add:Num"..msg.chat_id_..result.sender_user_id_,Num)  
...
database:set(bot_id..'TiTan:Lock:Added:Me'..msg.chat_id_,true)  
send(msg.chat_id_, msg.id_,'☑┇تم تعطيل امر منو ضافني') 
return false
end
if text and text:match("(.*)(ضافني)(.*)") then
if not database:get(bot_id..'TiTan:Lock:Added:Me'..msg.chat_id_) then
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
if da and da.status_.ID == "ChatMemberStatusCreator" then
send(msg.chat_id_, msg.id_,'📛┇انت منشئ المجموعه ') 
return false
end
local Added_Me = database:get(bot_id.."TiTan:Who:Added:Me"..msg.chat_id_..':'..msg.sender_user_id_)
if Added_Me then 
...
function reply(extra, result, success)
database:del(bot_id.."TiTan:Msg_User"..msg.chat_id_..":"..result.sender_user_id_) 
database:incrby(bot_id.."TiTan:messageUser"..msg.chat_id_..":"..result.sender_user_id_,Num)  
...
if text == "تنظيف المشتركين" and DevTiTan(msg) then
local pv = database:smembers(bot_id..'TiTan:UsersBot')  
local sendok = 0
for i = 1, #pv do
...
if text == "تنظيف الكروبات" and DevTiTan(msg) then
local group = database:smembers(bot_id..'TiTan:Chek:Groups')  
local w = 0
local q = 0
for i = 1, #group do
...
if text == 'تفعيل البوت الخدمي' and DevTiTan(msg) then  
database:del(bot_id..'TiTan:Free:Add:Bots') 
send(msg.chat_id_, msg.id_,'☑︙تم تفعيل البوت الخدمي ') 
end
if text == 'تعطيل البوت الخدمي' and DevTiTan(msg) then  
database:set(bot_id..'TiTan:Free:Add:Bots',true) 
send(msg.chat_id_, msg.id_,'☑︙تم تعطيل البوت الخدمي') 
end
if text and text:match("^تعين عدد الاعضاء (%d+)$") and DevTiTan(msg) then
local Num = text:match("تعين عدد الاعضاء (%d+)$") 
database:set(bot_id..'TiTan:Num:Add:Bot',Num) 
...
for k,v in pairs(list) do   
NAME = 'TiTan Chat'
ASAS = database:smembers(bot_id.."TiTan:Basic:Constructor"..v)
MNSH = database:smembers(bot_id.."TiTan:Constructor"..v)
MDER = database:smembers(bot_id.."TiTan:Manager"..v)
MOD = database:smembers(bot_id.."TiTan:Mod:User"..v)
link = database:get(bot_id.."TiTan:Link_Group"..v) or ''
if k == 1 then
t = t..'"'..v..'":{"TiTan":"'..NAME..'",'
else
t = t..',"'..v..'":{"TiTan":"'..NAME..'",'
...
local Text_Dev = database:get(bot_id..'TiTan:Text_Dev')
if Text_Dev then 
...
if text == 'وضع كليشه المطور' and DevTiTan(msg) then
database:set(bot_id..'TiTan:Set:Text_Dev'..msg.chat_id_,true)
send(msg.chat_id_,msg.id_,'📫┇ ارسل الكليشه الان')
return false
end
if text and database:get(bot_id..'TiTan:Set:Text_Dev'..msg.chat_id_) then
if text == 'الغاء' then 
database:del(bot_id..'TiTan:Set:Text_Dev'..msg.chat_id_)
send(msg.chat_id_,msg.id_,'🔖┇تم الغاء حفظ كليشة المطور')
return false
end
database:set(bot_id..'TiTan:Text_Dev',text)
database:del(bot_id..'TiTan:Set:Text_Dev'..msg.chat_id_)
send(msg.chat_id_,msg.id_,'🔰┇تم حفظ كليشة المطور')
return false
end
if text and text == "تفعيل تاك الادمنيه" and Owner(msg) then 
database:set(bot_id.."TiTan:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"⚠️┇تم تفعيل تاك الادمنيه")
end
if text and text == "تعطيل تاك الادمنيه" and Owner(msg) then 
database:del(bot_id.."TiTan:Tag:Admins:"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⚠️┇تم تعطيل تاك الادمنيه")
end
if text == 'صيح الادمنيه' or text == "تاك للادمنيه" or text == "وين الادمنيه" then
if database:get(bot_id.."TiTan:Tag:Admins:"..msg.chat_id_) then 
...
k = k + 1
local username = database:get(bot_id.."TiTan:User:Name"..v.user_id_)
if username then
t = t..""..k.."- ([@"..username.."])\n"
else
t = t..""..k.."- (`"..v.user_id_.."`)\n"
...
database:del(bot_id..'TiTan:Seh:User'..msg.chat_id_)  
send(msg.chat_id_, msg.id_,'☑┇تم تفعيل امر صيح') 
return false
end
if text == 'تعطيل صيح' and Owner(msg) then  
database:set(bot_id..'TiTan:Seh:User'..msg.chat_id_,true)  
send(msg.chat_id_, msg.id_,'☑┇تم تعطيل امر صيح') 
return false
end
if text and text:match("^صيح @(.*)$") then
local username = text:match("^صيح @(.*)$")
if not database:get(bot_id..'TiTan:Seh:User'..msg.chat_id_) then
...
if text == 'رفع النسخه الاحتياطيه' and DevTiTan(msg) then   
...
🔓︙قفل/فتح+الامر/بلكتم/بالطرد/بتالتقيد√
ꔹ┉♦️┉ ┉ ┉ ┉♦️┉ꔹ
🔖︙الروابط
🔖︙المعرف
🔖︙التاك
...
if database:sismember(bot_id..'TiTan:Chek:Groups',msg.chat_id_) then
...
database:sadd(bot_id..'TiTan:Chek:Groups',msg.chat_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
...
send(msg.chat_id_, msg.id_,'❕︙المجموعه معطله سابقا ~ '..chat.title_..'')
else
...
Reply_Status(msg,result.id_,'reply_Add','☑︙تم تفعيل المجموعه ~ '..chat.title_..'')
database:sadd(bot_id..'TiTan:Chek:Groups',msg.chat_id_)  
database:sadd(bot_id..'TiTan:Basic:Constructor'..msg.chat_id_, msg.sender_user_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NumMember = data.member_count_
local NameChat = chat.title_
NameChat = NameChat:gsub('"',"") 
...
if not database:get(bot_id..'TiTan:Start:Time'..msg.sender_user_id_) then
local start = database:get(bot_id.."Start:Bot")  
if start then 
Test = start
else
Test = '🌐┋مرحبا بك في بوت الحمايه\n🎫┋آنا آختصاصي حمايه المجموعات\n📛┋مـن آلسـبآم وآلتوجيه وآلتگرآر وآلخ...\n\n📨┋ارسل ما تريد وسارسله الى المطور\n\n🚶🏻‍♂️'
end 
send(msg.chat_id_, msg.id_, Test) 
end
end
database:setex(bot_id..'TiTan:Start:Time'..msg.sender_user_id_,60,true)
return false
end
if not DevTiTan(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') then
...
if DevTiTan(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if text=="اذاعه خاص 🗣️" and msg.reply_to_message_id_ == 0 then
if database:get(bot_id.."TiTan:Status:Bc") and not DevTiTan(msg) then 
send(msg.chat_id_, msg.id_,"📫︙الاذاعه معطله من قبل المطور الاساسي")
return false
end
...
database:set(bot_id..'TiTan:Set:Text_Dev'..msg.sender_user_id_,300,true)
send(msg.chat_id_,msg.id_,'📥︙ ارسل الكليشه الان')
return false
end
...
database:srem(bot_id..'TiTan:Chek:Groups','-100'..data.channel_.id_)  
end
end
...
if text and not database:sismember(bot_id..'TiTan:Spam:Group'..msg.sender_user_id_,text) then
database:del(bot_id..'TiTan:Spam:Group'..msg.sender_user_id_) 
end
------------------------------------------------------------------------
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
database:set(bot_id..'TiTan:User:Name'..msg.sender_user_id_,data.username_)
end;end,nil)   
------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then  
database:set(bot_id.."TiTan:Who:Added:Me"..msg.chat_id_..":"..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = database:get(bot_id.."TiTan:Lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
------------------------------------------------------------------------
if text and database:get(bot_id.."TiTan:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = database:get(bot_id.."TiTan:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
database:del(bot_id.."TiTan:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
database:del(bot_id.."TiTan:Set:Cmd:Group:New"..msg.chat_id_)
database:srem(bot_id.."TiTan:List:Cmd:Group:New"..msg.chat_id_,text)
...
database:del(bot_id.."TiTan:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
------------------------------------------------------------------------
if data.message_.content_.text_ then
local NewCmmd = database:get(bot_id.."TiTan:Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
local Name_Bot = (database:get(bot_id.."TiTan:Name:Bot") or "TiTan")
if not database:get(bot_id.."TiTan:Fun_Bots"..msg.chat_id_) then
...
------------------------------------------------------------------------
TiTan_Started_Bot(msg,data)
TiTan_Files(msg)
elseif (data.ID == "UpdateMessageEdited") then
local msg = data
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.message_id_)},function(extra, result, success)
database:incr(bot_id..'TiTan:message_edit'..result.chat_id_..result.sender_user_id_)
local Text = result.content_.text_
if database:get(bot_id.."TiTan:Lock:edit"..msg.chat_id_) and not Text and not BasicConstructor(result) then
local list = database:smembers(bot_id.."TiTan:Constructor"..msg.chat_id_)
if #list == 0 then
...
if database:get(bot_id.."TiTan:Lock:Link"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(@)(.*)") then
if database:get(bot_id.."TiTan:Lock:User:Name"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(#)(.*)") then
if database:get(bot_id.."TiTan:Lock:hashtak"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end 
...
------------------------------------------------------------------------
if text and text:match("/") then
if database:get(bot_id.."TiTan:Lock:Cmd"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end 
...
------------------------------------------------------------------------
if text then
local TiTan_Msg = database:get(bot_id.."TiTan:Add:Filter:Rp2"..text..result.chat_id_)   
if TiTan_Msg then    
Reply_Status(result,result.sender_user_id_,"reply","📬︙"..TiTan_Msg)  
DeleteMessage(result.chat_id_, {[0] = data.message_id_})     
return false
end
end
...
local msg = data.message_
local text = msg.content_.text_
local Get_Msg_Pin = database:get(bot_id..'TiTan:Msg:Pin:Chat'..msg.chat_id_)
if Get_Msg_Pin ~= nil then
if text == Get_Msg_Pin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;database:del(bot_id..'TiTan:Msg:Pin:Chat'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) database:del(bot_id..'TiTan:Msg:Pin:Chat'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
database:srem(bot_id..'TiTan:Chek:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
database:srem(bot_id..'TiTan:Chek:Groups',v)  
end
